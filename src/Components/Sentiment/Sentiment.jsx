...
const Sentiment = () => {
  return (
    <>
        <div className=' bg-white border rounded-3xl my-3'>
            <h3 className=' text-4xl px-7 pt-2 font-semibold mt-5'>Sentiment</h3>
            <div className='flex justify-start items-start p-7'>
                <div className='flex gap-5 m-3 p-7 bg-custom-bg border rounded-2xl'>
                ...
                aliquam nam sunt iure veniam .</div>
                <div className='text-gray2'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellat 
